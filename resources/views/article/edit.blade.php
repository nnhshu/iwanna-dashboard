...
@section('content')
<form action="{{ route('article.update', ['article' => $model->id ]) }}" enctype="multipart/form-data" method="post">
    @csrf
    @method('PATCH')
            ...
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    <div class="form-group mb-4">
                        ...
                        <input type="text" class="form-control @error('title') is-invalid @enderror" value="{{ old( 'title', $model->title ) }}" id="title" name="title" placeholder="Tiêu đề bài viết">
                        @error('title')
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" class="form-control" value="{{  $model->slug }}" id="title" name="title" placeholder="Tiêu đề bài viết" disabled>
                        
                    </div>
                    <div class="form-group mb-4">
                        <label for="Content">Mô tả ngắn bài viết</label>
                        <textarea class="form-control" row="6" name="content" aria-label="With textarea">{{ old( 'content', $model->short_desc ) }}</textarea>
                    </div>
                    <div class="form-group mb-4">
                        <label for="Content">Nội dung</label>
                        <textarea id="editor" class="form-control @error('content') is-invalid @enderror" row="6" name="content" aria-label="With textarea">
